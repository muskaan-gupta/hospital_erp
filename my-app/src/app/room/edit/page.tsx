...
export default function EditRoomAllotmentPage() {
  const [formData, setFormData] = useState({
    ...
    allotmentDate: '10-10-2018',
    dischargeDate: '16-10-2018',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (formData.patientName && formData.roomNumber) {
      setSuccessMessage('Updated Successfully! Please check in Allotment list');
      setErrorMessage('');
    } else {
      setSuccessMessage('');
  ...
  return (
    <div className="p-6 w-[80vw] text-black">
      <h1 className="text-3xl font-semibold text-pink-500">Edit Room Allotment</h1>
